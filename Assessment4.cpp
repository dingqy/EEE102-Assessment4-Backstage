...
void addBook() {
  ...
  temp.addBook(book1);
  Book book2 =
      Book("Modern Semiconductor Devices for Integrated Circuits",
           "978-7-03-032665-2", "Chengming Hu", "Beijing", "Stored", 88.0);
  temp.addBook(book2);
  temp.exit();
}
...
void searchBook() {
  Console temp;
  map<string, string> type;
  type["bookCondition"] = "Stored";
  type["borrowId"] = "1717572";
  vector<Book> booksearch1 = temp.searchBook(type);
